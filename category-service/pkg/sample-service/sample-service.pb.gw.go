...
func RegisterSampleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SampleServiceServer) error {
	...
	mux.Handle("POST", pattern_SampleService_SampleMethodV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ozonmp.omp_grpc_template.sample_service.v1.SampleService/SampleMethodV1", runtime.WithHTTPPathPattern("/v1/sample"))
		if err != nil {
...
func RegisterSampleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SampleServiceClient) error {
	...
	mux.Handle("POST", pattern_SampleService_SampleMethodV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ozonmp.omp_grpc_template.sample_service.v1.SampleService/SampleMethodV1", runtime.WithHTTPPathPattern("/v1/sample"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
