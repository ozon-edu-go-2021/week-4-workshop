...
func RegisterSampleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SampleServiceServer) error {
	...
	mux.Handle("POST", pattern_SampleService_SampleMethodV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ozonmp.week_3_workshop.category_service.category_service.v1.SampleService/SampleMethodV1", runtime.WithHTTPPathPattern("/v1/sample"))
		if err != nil {
...
func RegisterSampleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SampleServiceClient) error {
	...
	mux.Handle("POST", pattern_SampleService_SampleMethodV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ozonmp.week_3_workshop.category_service.category_service.v1.SampleService/SampleMethodV1", runtime.WithHTTPPathPattern("/v1/sample"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_SampleService_SampleMethodV1_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "sample"}, ""))
)
